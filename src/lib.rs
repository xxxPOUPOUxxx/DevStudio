...
#[derive(Debug)]
pub struct DevStudioProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DevStudioProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DevStudio processing");
    
    let mut processor = DevStudioProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DevStudioProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DevStudioProcessor::new(false);
